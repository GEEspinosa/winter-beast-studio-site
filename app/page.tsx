        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {featuredHomepageReleases.map((release) => (
            <div
              ...
              className="border border-zinc-300/20 p-[2px]"
            >
              <img
  ...
  <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
    ...
    <div>
      ...
      <div className="mt-6 text-sm leading-relaxed text-zinc-400 space-y-4">
        ...
        <p>
          Winterbeast is a recording environment built around sustained attention
          to records over time rather than short, transactional sessions.
        </p>

        <p>
          Work develops through repetition, listening, and revision. Takes are not
          treated as raw material to be fixed later, but part of an evolving structure
          shaped gradually through collaboration.
        </p>

        <p>
          The focus is on albums as complete objects rather than isolated deliverables.
          Sessions are organized to allow decisions to remain open long enough for
          the material to define its own direction.
        </p>
    ...
    {/* IMAGE */}
    <div className="border border-zinc-300/20 p-[2px] bg-[#202020]">
      <img
